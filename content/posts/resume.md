---
title: "Resume"
date: 2026-08-21T21:46:48-04:00
draft: false
...
- Implemented asynchronous streaming workflows with Python asyncio and separated real-time event delivery from conventional HTTP API requests.
- Built rolling-window calculations for stock-price ratios, including upper/lower bounds and threshold-based alerts.
- Added timestamp and stock-key deduplication to address duplicate streaming data and improve update consistency.
- Implemented CSV replay and synthetic-data generation to support repeatable testing and simulated real-time workloads.
...
- Implemented REST APIs for registration, authentication, profiles, guest access, account upgrades, games, and dashboards.
- Built JWT-based authentication and authorization using HTTP-only cookies and secure cookie configuration.
- Integrated MongoDB through Mongoose for user management, uniqueness checks, profile operations, and account lifecycle workflows.
...
- Built a computer-vision pipeline involving WPOD-Net and MobileNet for license-plate detection and OCR-related processing.
...
- Built preprocessing and feature-extraction workflows to convert raw audio into model-ready representations for training and evaluation.
- Used TensorFlow/Keras, NumPy, librosa, and scikit-learn throughout the experimentation and evaluation workflow.
